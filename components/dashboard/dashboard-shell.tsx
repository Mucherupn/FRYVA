...
const ROLE_NAV: Record<AppRole, NavItem[]> = {
  owner: [
    ...
    { href: '/owner/staff-meals', label: 'Staff Meals', group: 'Intelligence' },
    ...
    { href: '/owner/stock-alerts', label: 'Stock Alerts', group: 'Control' },
  ...
  chef: [
    ...
    { href: '/chef/closing-stock', label: 'Closing stock', group: 'Kitchen' },
